...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/bluetooth_enable_fork/bluetooth_enable_fork.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_beep/flutter_beep.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/jailbreak_root_detection/jailbreak_root_detection.framework"
