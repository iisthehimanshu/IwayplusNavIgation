                  ...
                  children: [
                      ...
                      child: Row(
                        children: [
                          ...
                          !ListExpand? Container(child:  Text(
                            ...
                            "${widget.Turns} Turns (${widget.TotalDistanceInFeet*0.3048} m)",
                            style: const TextStyle(
                              fontFamily: "Roboto",
                              fontSize: 14,
                              fontWeight: FontWeight.w500,
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Semantics(
                          // label:index==widget.directionList.length-1? ""
                          //     "${direction.turnDirection} ${
                          //     ((direction.turnDirection??"").substring(0,4)=="Take")?
                          //         "${direction.distanceToNextTurnInFeet}" :"${((direction.distanceToNextTurnInFeet??0)*0.3048).ceil()} m"}, you'll reach ${!widget.IsMultiBuilding || widget.reverse?widget.EndName:widget.StartBuildingName}":"${direction.turnDirection} ${((direction.turnDirection??"").substring(0,4)=="Take")? "${direction.distanceToNextTurnInFeet!*0.3048}" :"${((direction.distanceToNextTurnInFeet!=null)?direction.distanceToNextTurnInFeet!*0.3048).ceil()} m"}",
