        ...
        if (dist <= 15) {
          ...
          if (intersectPoints.isNotEmpty) {
           for(int i=ind1;i<=ind2;i++){
            ...
            getPoints.remove([getPoints[i][0],getPoints[i][1]]);
           getPoints.remove([getPoints[i+1][0],getPoints[i+1][1]]);

            getPoints.add([intersectPoints[0],intersectPoints[1]]);
          }
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: TextButton(
                                        onPressed: () async {
                                          print(
                                              "checkingshow ${user.showcoordX.toInt()}, ${user.showcoordY.toInt()}");
